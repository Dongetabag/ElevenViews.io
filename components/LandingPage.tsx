    ...
    <div className="min-h-screen bg-brand-dark text-white flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="text-center relative z-10 p-6 max-w-full sm:max-w-5xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 mb-16">
          <button
            onClick={onRegister}
            className="group relative flex items-center justify-center gap-3 px-10 py-5 min-h-[56px] min-w-[200px] bg-brand-gold text-brand-dark font-semibold text-base transition-all duration-300 rounded-xl hover:bg-brand-gold/90 hover:scale-[1.02] active:scale-[0.98] shadow-[0_0_40px_rgba(201,169,98,0.15)] touch-manipulation"
          >
          ...
          <button
            onClick={onLogin}
            className="group relative flex items-center justify-center gap-3 px-10 py-5 min-h-[56px] min-w-[200px] bg-white/5 border border-white/10 text-white font-medium text-base transition-all duration-300 rounded-xl hover:bg-white/10 hover:border-white/20 active:scale-[0.98] touch-manipulation"
          >
            <LogIn className="w-6 h-6 text-brand-gold/80" />
            <span className="font-display tracking-wide">Crew Login</span>
          </button>
        </div>

        {/* Industries Grid */}
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 max-w-3xl mx-auto mb-16 px-4">
          <div className="glass-gold rounded-2xl p-6 text-center hover:border-brand-gold/20 transition-all touch-manipulation active:scale-[0.98] min-h-[120px] flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-500">Artists & Labels</p>
          </div>
          <div className="glass-gold rounded-2xl p-6 text-center hover:border-brand-gold/20 transition-all touch-manipulation active:scale-[0.98] min-h-[120px] flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-500">Directors & Producers</p>
          </div>
          <div className="glass-gold rounded-2xl p-6 text-center hover:border-brand-gold/20 transition-all touch-manipulation active:scale-[0.98] min-h-[120px] flex flex-col items-center justify-center">
            ...
            <p className="text-xs text-gray-500">Designers & Stylists</p>
          </div>
          <div className="glass-gold rounded-2xl p-6 text-center hover:border-brand-gold/20 transition-all touch-manipulation active:scale-[0.98] min-h-[120px] flex flex-col items-center justify-center">
            <Aperture className="w-8 h-8 text-brand-gold mx-auto mb-3" />
            <h3 className="text-sm font-display font-semibold text-white mb-1">Design</h3>
            <p className="text-xs text-gray-500">Creatives & Visionaries</p>
          </div>
        </div>

        {/* Stats */}
        <div className="flex items-center justify-center px-4 w-full">
          <div className="inline-flex items-center gap-3 sm:gap-8 px-3 sm:px-8 py-5 glass rounded-2xl max-w-full">
            <div className="text-center min-w-[70px]">
              <p className="text-xl font-display font-bold text-white">11</p>
              <p className="text-[10px] sm:text-xs uppercase tracking-wider text-gray-500 mt-1">Core Members</p>
            </div>
            <div className="w-px h-10 bg-white/10"></div>
            <div className="text-center min-w-[70px]">
              <p className="text-xl font-display font-bold text-white">4</p>
              <p className="text-[10px] sm:text-xs uppercase tracking-wider text-gray-500 mt-1">Industries</p>
            </div>
            <div className="w-px h-10 bg-white/10"></div>
            <div className="text-center min-w-[60px]">
              <p className="text-xl font-display font-bold text-white">1</p>
              <p className="text-[10px] sm:text-xs uppercase tracking-wider text-gray-500 mt-1">Vision</p>
            </div>
          </div>
        </div>
