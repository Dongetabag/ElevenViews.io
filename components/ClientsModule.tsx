    ...
    return (
      <div className="p-4 sm:p-6 lg:p-8 h-full flex flex-col">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0 mb-6">
          <h2 className="text-xl sm:text-2xl font-bold text-white font-orbitron">Client Management</h2>
          <button
          ...
          <div key={client.id} className="glass p-6 rounded-2xl border-white/5 hover:border-brand-gold/20 transition-all group relative overflow-hidden">
            ...
            <div className="flex justify-between items-start relative z-10">
              ...
              <div className="flex gap-1">
                <button onClick={() => handleEdit(client)} className="p-2 min-h-[44px] min-w-[44px] flex items-center justify-center text-gray-600 hover:text-brand-gold">
                  <MoreVertical className="w-5 h-5" />
                </button>
                <button onClick={() => handleDelete(client.id)} className="p-2 min-h-[44px] min-w-[44px] flex items-center justify-center text-gray-600 hover:text-red-500">
            ...
            <div className="mt-4 sm:mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 relative z-10">
